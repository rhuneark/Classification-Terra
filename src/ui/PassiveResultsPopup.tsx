...
export default function PassiveResultsPopup() {
    ...
    const hoursLabel = results.hoursAway < 1
        ? 'less than an hour'
        : results.hoursAway === 1 ? '1 hour'
        : `${results.hoursAway} hours`;

    return (
        <div className="absolute inset-0 flex items-center justify-center px-6" style={{ background: 'rgba(0,0,0,0.85)', zIndex: 50 }}>
            <div className="w-full max-w-sm rounded p-6" style={{ background: '#0e2010', border: '1px solid #243e26' }}>
                ...
                <p className="mt-1 text-[0.85rem]" style={{ color: '#a0c0a2' }}>
                ...
                <div className="mt-4 space-y-2">
                    ...
                    {results.battlesCount > 0 && (
                        <>
                            <div className="flex justify-between text-[0.92rem]">
                                <span style={{ color: '#a0c0a2' }}>Passive battles</span>
                    ...
                    {results.battlesCount === 0 && results.energyGained === 0 && (
                        <p className="text-[0.85rem]" style={{ color: '#a0c0a2' }}>
